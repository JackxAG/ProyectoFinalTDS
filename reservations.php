...
$reservations = [];
$query = "SELECT nombre, fecha, hora, COUNT(*) as count FROM reservas GROUP BY fecha, hora ORDER BY fecha, hora";
$result = mysqli_query($conex, $query);
if ($result) {
...
<body>
    <header>
        <div class="logo">
            <img src="images/BENDITO-LOGO2.png" alt="La Deliciosa Logo">
        </div>
        <nav>
        <ul>
